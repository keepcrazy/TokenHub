export const jaTranslations: Record<string, string> = {
    ...
    "近期有请求触发额度限制": "最近のリクエストでクォータ制限が発生しました",
    "可在审批记录中处理。": "承認記録で処理できます。",
    "最近 100 条可见请求中，该项目下有请求触发额度限制；请先核对 Key 与项目额度，再提交相应调整。": "表示可能な最新100件のリクエストで、このプロジェクト配下のリクエストがクォータ制限に達しました。Keyとプロジェクトのクォータを確認してから、必要な変更を申請してください。",
    "待审批": "承認待ち",
    "需提升": "増額が必要",
    "日请求": "日次リクエスト",
    "月请求": "月次リクエスト",

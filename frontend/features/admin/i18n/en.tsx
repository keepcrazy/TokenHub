export const enTranslations: Record<string, string> = {
    ...
    "错误请求": "Error Requests",
    "计费请求": "Billable Requests",
    "计费错误": "Billable Errors",
    "记录": "Records",
    "条匹配": "matches",
    "没有匹配结果": "No matches",
    ...
    "近期有请求触发额度限制": "A recent request hit a quota limit",
    "可在审批记录中处理。": "Handle it in approval records.",
    "最近 100 条可见请求中，该项目下有请求触发额度限制；请先核对 Key 与项目额度，再提交相应调整。": "Within the latest 100 visible requests, a request under this project hit a quota limit. Check both the Key and project quotas before submitting the appropriate adjustment.",

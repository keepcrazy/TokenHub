...
TOKENHUB_UPSTREAM_NON_STREAM_TIMEOUT_SECONDS="${TOKENHUB_UPSTREAM_NON_STREAM_TIMEOUT_SECONDS:-300}"
...
TOKENHUB_IMAGE_WORKER_CONCURRENCY="${TOKENHUB_IMAGE_WORKER_CONCURRENCY:-6}"
